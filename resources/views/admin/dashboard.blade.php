...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <style>
    ...
    .sidenav,.list-group-item{
      ...
      /* background-color: rgb(12, 23, 174); */
      /* background-color: rgb(34, 0, 76); */
    ...
    /* .list-group-item{
        /* border:#b40000; */
        border:41px solid rgb(255, 255, 255);
    }
 */
              ...
              <div class="container mt-5">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="card"  id="dcontent">
                              <div class="card-body">
                                  <h5 class="card-title" style="color:rgb(255, 255, 255);font-size:20px;font-weight:bold">Companies</h5>
                      ...
                      <div class="col-md-6">
                        <div class="card"  id="dcontent">
                            <div class="card-body">
                                <h5 class="card-title" style="color:rgb(255, 255, 255);font-size:20px;font-weight:bold">Students Active</h5>
                                <p class="card-text" >1</p>
                            </div>
                        </div>
                    </div><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card"  id="dcontent">
                            <div class="card-body">
                                <h5 class="card-title" style="color:rgb(255, 255, 255);font-size:20px;font-weight:bold">Staffs</h5>
                                <p class="card-text" >1</p>
                            </div>
                        </div>
                    </div><br>
...
<div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <center><p style="color:#997b7b">Number of Students and number of students eligible for companies</p></center>
      </div>
      <div class="col-md-6">
        <!-- Chart 2 -->
        <canvas id="myPieChart"></canvas>
        <br>
        <center><p style="color:#7b9993">Students Belonging to several departments</p></center>
      </div>
    </div>
  </div>
