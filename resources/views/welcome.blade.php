...
<body class="bg-white text-black dark:bg-gray-900 dark:text-white transition-colors duration-300">
    ...
    <nav class="navbar bg-base-100 px-10 shadow-lg fixed top-0 z-10 mb-10 w-full">
        <div class="navbar-start">
            ...
            <a class="btn btn-ghost text-xl">
                <img src="https://res.cloudinary.com/dght6acvp/image/upload/v1718788322/1_xvgbwf.webp" class="w-20" alt="Logo">
            </a>
        </div>
        ...
        <div class="navbar-end">
            <button id="theme-toggle" class="btn btn-ghost">
                <svg id="theme-toggle-light-icon" class="w-6 h-6 dark-mode-hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v3m0 12v3m-4.219-2.219l-2.122-2.122m12.263 0l-2.121 2.121M6 12H3m18 0h-3M8.464 8.464l-2.122-2.121m12.263 0l-2.121 2.121"></path>
                </svg>
                <svg id="theme-toggle-dark-icon" class="w-6 h-6 dark-mode-visible" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m8.485-4.515l-.707-.707m-15.556 0l-.707.707m15.556-10.728l.707-.707m-15.556 0l-.707.707M18 12a6 6 0 11-12 0 6 6 0 0112 0z"></path>
                </svg>
            </button>
